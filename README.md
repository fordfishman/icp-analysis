...
`QA_QC` is a list-type object that will store information about the various checks. The IPC-500, LFM, and CCB checks all look at multiple samples. Their corresponding variables keep track of how many samples of each have gone through the check.
