...
######################################### SETUP ########################################
# Files, data, and packages all come via shiny

# Saves the sheet with concentration data into a dataframe 
# file is the main output of the ICP
# Saves the sheet with concentration data into a dataframe
field_foams_concentrations_df <- read_excel(path = file, sheet = "Conc. in Calib Units")

# Rename some columns to remove ambiguous characters and correct any mistakes
